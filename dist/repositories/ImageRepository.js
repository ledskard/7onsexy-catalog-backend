...
var ImageRepository = /** @class */ (function () {
    ...
    ImageRepository.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.imageRepository.save(data)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ImageRepository.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.imageRepository.delete(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
