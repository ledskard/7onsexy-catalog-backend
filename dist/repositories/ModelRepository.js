...
var ModelRepository = /** @class */ (function () {
    function ModelRepository() {
        this.modelRepository = data_source_1.AppDataSource.getRepository(Model_1.Model);
    }
    ModelRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modelRepository.create(data)];
                    case 1:
                        model = _a.sent();
                        return [4 /*yield*/, this.modelRepository.save(model)];
                    case 2:
                        _a.sent();
    ...
    ModelRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ModelRepository.prototype.findAll = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        model = _a.sent();
                        if (type) {
                            model.andWhere("m.type = :type", { type: type });
                        }
                        return [2 /*return*/, model.getMany()];
                }
            });
        });
    };
    ...
    ModelRepository.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
