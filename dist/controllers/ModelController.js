...
var ModelController = /** @class */ (function () {
    ...
    ModelController.prototype.findById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, modelService, model, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        modelService = new ModelService_1.default();
                        return [4 /*yield*/, modelService.findById(id)];
                    case 1:
                        model = _a.sent();
                        return [2 /*return*/, res.status(200).json(model)];
                    case 2:
                        err_2 = _a.sent();
                        return [2 /*return*/, (0, ProcessError_1.ProcessError)(res, err_2)];
                    case 3: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        id = req.params.id;
                        modelService = new ModelService_1.default();
                        return [4 /*yield*/, modelService.increaseLike(id)];
                    case 1:
                        model = _a.sent();
                        return [2 /*return*/, res.status(200).json(model)];
                    case 2:
