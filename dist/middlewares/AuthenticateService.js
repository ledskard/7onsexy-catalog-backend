...
var AuthenticateService = /** @class */ (function () {
    ...
    AuthenticateService.prototype.authenticate = function (username, password) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user)
                            throw { status: ErrorConstants_1.ErrorStatus.bad_request, message: ErrorConstants_1.ErrorMessage.user_or_password_incorrect };
                        return [4 /*yield*/, bcrypt.compare(password, user.password)];
                    case 2:
                        validPassword = _a.sent();
                        if (!validPassword)
                            throw { status: 400, message: ErrorConstants_1.ErrorMessage.password_invalid };
